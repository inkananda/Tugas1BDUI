...
if ($query_update_ok){
	header("location: http://localhost/dkaryawan/daftar_karyawan/home.php?status=SuksesUpdate");
}else{
	header("location: http://localhost/dkaryawan/daftar_karyawan/home.php?status=GagalUpdate");
}
}
else{
}
